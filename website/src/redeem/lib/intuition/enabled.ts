...
/**
 * Source of truth for active/revoked: the origin-chain DelegationManager. Intuition
 * indexes which delegations exist; this confirms one is still enabled (not disabled
 * via disableDelegation). See spec/intuition/README.md "Active vs revoked".
 */
